...
superleader = max(node_points, key=node_points.get)
print("Superleader (Random Walk):", superleader)

# -------------------------------
# PageRank Implementation
# -------------------------------
pagerank_scores = nx.pagerank(G)
pagerank_leader = max(pagerank_scores, key=pagerank_scores.get)
print("Superleader (PageRank):", pagerank_leader)
